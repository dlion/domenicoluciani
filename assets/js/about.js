...
(function () {
  ...
  ready(function () {
    ...
    // tile layers (N.B. nessun .addTo qui)
    ...
    // dark minimale e stabile (Esri)
    var darkTiles = L.tileLayer(
      'https://server.arcgisonline.com/ArcGIS/rest/services/Canvas/World_Dark_Gray_Base/MapServer/tile/{z}/{y}/{x}',
      { attribution: 'Tiles © Esri — Esri, DeLorme, NAVTEQ', noWrap: true, maxZoom: 16 }
    );

    // scegli il tema iniziale e aggiungi SOLO dopo che map esiste
